...
config :video_conference, VideoConferenceWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: VideoConferenceWeb.ErrorHTML, json: VideoConferenceWeb.ErrorJSON],
    layout: false
  ],
...
config :video_conference, VideoConference.Mailer, adapter: Swoosh.Adapters.Local
