...
config :video_conference, VideoConferenceWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "cN1hgi8RCDQuorQ8/hRTEjsGwBO0KQuP0b9Fk7m5TVw3zPYuv7g4QDyq6+XcTUOr",
  watchers: [
...
config :video_conference, VideoConferenceWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/video_conference_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :video_conference, dev_routes: true
